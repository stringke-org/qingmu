...
use deno_core::{
    error::AnyError, futures::FutureExt, ModuleLoader, ModuleLoadResponse, ModuleSource, ModuleSourceCode,
    ModuleSpecifier, RequestedModuleType, ResolutionKind, url::Url,
};
    ...
    fn load(
        ...
        ModuleLoadResponse::Async(
            async move {
                ...
                let module_str = module_specifier.as_str();

                // Load and return module.
                let module = ModuleSource::new(
                    module_type,
                    ModuleSourceCode::String(code.into()),
                    &Url::parse(module_str)?,
                );
